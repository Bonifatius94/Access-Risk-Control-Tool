...
public class H2AccountsTest {
    ...
    public void testCreateDatabaseUser() {
        ...
        try (ArtDbContext context = new ArtDbContext("test", "test")) {
            ...
            context.createDatabaseUser(new DbUser("FooAdmin", new LinkedHashSet<>(Arrays.asList(DbUserRole.Admin, DbUserRole.Configurator))), "foobar");
            context.createDatabaseUser(new DbUser("FooConfigurator", new LinkedHashSet<>(Arrays.asList(DbUserRole.Viewer, DbUserRole.Configurator))), "foobar");
            context.createDatabaseUser(new DbUser("FooViewer", new LinkedHashSet<>(Arrays.asList(DbUserRole.Viewer))), "foobar");
    ...
    public void testChangeUserRole() {
        ...
        try (ArtDbContext context = new ArtDbContext("test", "test")) {
            ...
            String username = "FOO";
            DbUser foo = new DbUser(username, new LinkedHashSet<>(Arrays.asList(DbUserRole.Viewer)));
    ...
    public void testFirstLogin() {
        ...
        try (ArtDbContext context = new ArtDbContext("test", "test")) {
            ...
            // create new user as viewer
            DbUser user = new DbUser(username, new LinkedHashSet<>(Arrays.asList(DbUserRole.Viewer)));
