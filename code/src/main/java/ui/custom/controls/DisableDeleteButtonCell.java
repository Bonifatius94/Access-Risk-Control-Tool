...
public class DisableDeleteButtonCell<S> extends TableCell<S, JFXButton>  {
     ...
     */
    public DisableDeleteButtonCell(Function<S, S> function) {
        ...
        this.actionButton.setTooltip(new Tooltip(bundle.getString("delete")));
